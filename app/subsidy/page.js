...
export const metadata = {
  ...
  description:
    "太陽光発電・家庭用蓄電池の補助金を、国（SIIのDR補助金・みらいエコ住宅2026）＋自治体（東京都 令和8年度 等）でまとめた最新データベース。各制度の対象・単価・上限・期間・受付状況を、公式の出典URLと確認日つきで掲載します。補助金は流動的なため『公式で確認できた範囲』を正直に示します。",
};
...
export default function SubsidyPage() {
  return (
    <main style={{ maxWidth: 780, margin: "0 auto", padding: "2.5rem 1.5rem 4rem" }}>
      ...
      <p style={{ letterSpacing: 2, fontSize: 12, color: "#0a7d3c", fontWeight: 700, margin: 0 }}>SUBSIDY DATABASE</p>
      ...
      <section style={{ marginTop: 40, borderTop: "1px solid #e3e9ee", paddingTop: 24 }}>
        <h2 style={{ fontSize: "1.1rem", color: "#1a2b3c", margin: "0 0 10px" }}>このデータについて（出典・更新方針）</h2>
